  ...
  template: `
    <section class="py-16">
      <div class="max-w-3xl mx-auto px-4">
        <h2 class="text-4xl font-extrabold text-gray-900 mb-6 text-center">Login</h2>
        <form class="space-y-4">
          ...
          <button class="w-full bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700 transition">Login</button>
        </form>

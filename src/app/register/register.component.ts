    ...
    <section class="py-12">
      <div class="container mx-auto px-4 max-w-md">
        ...
        <form class="space-y-4">
          ...
          <input type="password" placeholder="Confirm Password" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
